      ...
      variant: {
        ...
        destructive:
          "bg-destructive text-white hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60 shadow-sm hover:shadow-md active:scale-[0.98]",
               outline:
                 "border border-border/80 bg-background shadow-sm hover:bg-accent/50 hover:text-accent-foreground hover:border-border/80 dark:bg-input/30 dark:border-input dark:hover:bg-input/50 active:scale-[0.98]",
        secondary:
          "bg-secondary/80 text-secondary-foreground hover:bg-secondary shadow-sm hover:shadow active:scale-[0.98]",
        ghost:
          "hover:bg-accent/50 hover:text-accent-foreground dark:hover:bg-accent/30 active:scale-[0.98]",
